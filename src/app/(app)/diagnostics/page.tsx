...
export default async function DiagnosticsHubPage() {
  ...
  if (!child) {
    ...
    return (
      <DiagnosticsNoChildState
        serverPendingDiagnostic={
          pendingLead && pendingScore != null
            ? {
                score: pendingScore,
                status: pendingStatus!,
                aiSummary: pendingLead.diagnostic_ai_summary as string | null,
                completedAt: pendingLead.diagnostic_completed_at as string | null,
              }
            : null
        }
      />
